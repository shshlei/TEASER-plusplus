...
public:
  ...
  // element access
  inline PointXYZ & operator[](size_t i)
  {
    return points_[i];
  }
  inline const PointXYZ & operator[](size_t i) const
  {
    return points_[i];
  }
  inline PointXYZ & at(size_t n)
  {
    return points_.at(n);
  }
  inline const PointXYZ & at(size_t n) const
  {
    return points_.at(n);
  }
  inline PointXYZ & front()
  {
    return points_.front();
  }
  inline const PointXYZ & front() const
  {
    return points_.front();
  }
  inline PointXYZ & back()
  {
    return points_.back();
  }
  inline const PointXYZ & back() const
  {
    return points_.back();
  }

  inline void push_back(const PointXYZ & pt)
  {
    points_.push_back(pt);
  }
  inline void push_back(PointXYZ & pt)
  {
    points_.push_back(pt);
  }
